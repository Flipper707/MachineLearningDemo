...
X_test_scaled = scaler.transform(X_test)  # transforming X_test. DO NOT FIT THEM because dobbiamo applicare la transformation basandoci solo sull'addestramento
...
# performing the training o the train data(i.e. X_train_scaled, y_train)
...
print(f"\nAfter the training, the params fro the Regressor are: {model.coef_}") # the coefficient of the model
